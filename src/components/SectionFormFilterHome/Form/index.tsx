    ...
    return (
        <form className={styles.form} onSubmit={(e) => e.preventDefault()}>
            <div className={styles.tab}>
                <button
                    className={active === 'car' ? styles.active : null}
                    onClick={() => setActive('car')}
                >
                    Comprar carros
                </button>
                <button
                    className={active === 'motorcycle' ? styles.active : null}
                    onClick={() => setActive('motorcycle')}
                >
                    Comprar motos
                </button>
            </div>
            <div className={styles.content}>
                ...
                <button className={styles.btn} onClick={() => router.push('/carros  ')}>VER OFERTAS</button>
                <button
